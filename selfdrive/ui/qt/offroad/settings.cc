...
SunnypilotPanel::SunnypilotPanel(QWidget* parent) : QWidget(parent) {
  ...
  toggles.append(new ParamControl("StockLongSpeedLimitControl",
                                  "Enable Stock Longitudinal Speed Limit Control*",
                                  "Enable stock ACC to use speed limit signs information from map data and car interface to automatically adapt cruise speed to road limits.\n*This feature must be enabled along with \"Enable Speed Limit Control\" toggle.",
                                  "../assets/offroad/icon_speed_limit.png",
                                  this));
